...
const projects = [
  {
    ...
    fullDescription:
      'This project is a comprehensive web application designed to help users manage their personal finances effectively. It includes features such as expense tracking, budget planning, and financial goal setting. Built with React for the frontend and Node.js for the backend, it offers a responsive and intuitive user interface coupled with robust data management.',
